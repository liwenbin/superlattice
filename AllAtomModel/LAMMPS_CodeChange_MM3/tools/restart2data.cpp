...
class Data {
 public:
  ...
  double *angle_class2_k2,*angle_class2_k3,*angle_class2_k4,*angle_class2_k5,*angle_class2_k6;
...
void angle(FILE *fp, Data &data)
{
  if (strcmp(data.angle_style,"none") == 0) {
    ...
    data.angle_class2_k5 = new double[data.nangletypes+1];
    data.angle_class2_k6 = new double[data.nangletypes+1];
    ...
    nread_double(&data.angle_class2_k5[1],data.nangletypes,fp);
    nread_double(&data.angle_class2_k6[1],data.nangletypes,fp);
...
void Data::write(FILE *fp, FILE *fp2, int write_coeffs, int write_vels)
{
  ...
  if (write_coeffs && angle_style && fp2 == NULL) {
	...
	fprintf(fp,"%d %g %g %g %g %g %g\n",i,
		...
		angle_class2_k3[i],angle_class2_k4[i],angle_class2_k5[i],angle_class2_k6[i]);
