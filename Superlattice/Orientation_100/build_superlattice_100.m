...
%%% the MATLAB code in the directory UnitedAtomModel/Superlattice
...
%%% [100] oriented Nanoparticle Superlattice
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%% "primitive cell" dimension: (sqrt(2)*a) times (sqrt(2)*a) times (sqrt(2)*a)
...
xperiod = 3; yperiod = 3; zperiod = 3;

%%% each "primitive cell" contains 8 nanoparticles
np_total = xperiod*yperiod*zperiod*4;

%%% "primitive cell" dimensions
lx = sqrt(2)*np_distance; ly = sqrt(2)*np_distance; lz = sqrt(2)*np_distance;
...
for i = 0:xperiod-1
  for j = 0:yperiod-1
    for k = 0:zperiod-1
      ...
      Nanoxtal_Center(NP2Now+3 , :) = [lx/2 0 lz/2] + [lx 0 0]*i + [0 ly 0]*j + [0 0 lz]*k;
      Nanoxtal_Center(NP2Now+4 , :) = [0 ly/2 lz/2] + [lx 0 0]*i + [0 ly 0]*j + [0 0 lz]*k;
